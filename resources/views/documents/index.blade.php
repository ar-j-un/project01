                                    ...
                                    @push('modals')
                                        <div class="modal fade" id="addFileModal-{{ $document->id }}" tabindex="-1"
                                            ...
                                            <div class="modal-dialog modal-dialog-centered" role="document">
                                                <div class="modal-content">
                                                    <div class="modal-header">
                                                        <h5 class="modal-title" id="addFileModalLabel-{{ $document->id }}">Add
                                                            File</h5>
                                                        <button type="button" class="close" data-dismiss="modal"
                                                            aria-label="Close">
                                                            <span aria-hidden="true">&times;</span>
                                                    ...
                                                    <div class="modal-body">
                                                        <form action="{{ route('document-files.store', $document) }}"
                                                            method="POST" enctype="multipart/form-data" class="js-add-file-form"
                                                                ...
                                                                <div class="col-md-5 mb-2 mb-md-0">
                                                                    ...
                                                                    <div class="custom-file custom-file-sm">
                                                                        ...
                                                                        <label class="custom-file-label"
                                                                            for="fileInput-{{ $document->id }}"
                                                                            id="fileInputLabel-{{ $document->id }}">
                                                                            Choose file
                                                                        </label>
                                                                    </div>
                                                ...
                                                <div class="modal-content">
                                                    <div class="modal-header">
                                                        <h5 class="modal-title"
                                                            id="deleteDocumentModalLabel-{{ $document->id }}">Delete Document
                                                        </h5>
                                                        <button type="button" class="close" data-dismiss="modal"
                                                            aria-label="Close">
                                                            <span aria-hidden="true">&times;</span>
